...
- **Asset and static copy** runs synchronously during Phase 3 (output), after all content rendering and hooks complete. Background goroutine parallelism was attempted (#492, #501) but caused I/O contention with template rendering — 31% build regression on a 431-page site (issue #507). Sequential copy is faster and simpler.
