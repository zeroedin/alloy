...
| `render-codeblock` | `inner` (HTML-escaped code text — angle brackets, ampersands, and quotes are entity-encoded so HTML displays as text, not markup), `language`, `attributes` |
