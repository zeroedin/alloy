...
date: 2026-07-11
type: minor
description: "Style any Markdown block element with attributes, write permalinks as full template expressions, and use a single layout name across all output formats."
---
