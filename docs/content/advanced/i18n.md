...
<alloy-code language="liquid">&lt;html lang="{{ site.language.code }}"&gt;
&lt;head&gt;
  &lt;title&gt;{{ page.title }} | {{ site.title }}&lt;/title&gt;
&lt;/head&gt;</alloy-code>
</wa-tab-panel>
<wa-tab-panel name="i18n-lang-go">
<alloy-code language="html">&lt;html lang="{{ .site.language.code }}"&gt;
&lt;head&gt;
  &lt;title&gt;{{ .page.title }} | {{ .site.title }}&lt;/title&gt;
&lt;/head&gt;</alloy-code>
</wa-tab-panel>
...
<alloy-code language="liquid">&lt;nav aria-label="translations"&gt;
...
<alloy-code language="html">&lt;nav aria-label="translations"&gt;
...
<alloy-code language="liquid">&lt;!-- layouts/partials/head.liquid --&gt;
{% for translation in page.translations %}
...
<alloy-code language="html">&lt;!-- layouts/partials/head.html --&gt;
{{ range .page.translations }}
